...
TRAIN_VAL_SOURCE = r"E:\Tese\Datasets\Rempe\processed_datasets\treino" #ALTERAR
TEST_SOURCE = r"E:\Tese\Datasets\Rempe\processed_datasets\teste" #ALTERAR
#PODE SER PRECISO APAGAR A PASTA data
