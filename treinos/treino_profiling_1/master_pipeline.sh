#!/bin/bash
#SBATCH --job-name=rempe_pipeline_8gpus_MEDNEXT_Profiling
...
#SBATCH --output=logs/pipeline_mednext_4GPUS_profiling_%j.log
#SBATCH --error=logs/pipeline_mednext_4GPUS_profiling_%j.err
...
echo "2 NÓS - 3 GPUS/NÓ"
echo "=========================================================="
pipeline_start=$(date +%s)


# ==============================================================================
# FASE 1: RETOMAR TREINO DDP com SNAPSHOT
echo " iInício do Treino - MEDNEXT "
echo " Head Node: $head_node"
echo " Working Dir: $RUN_DIR"
echo "2 NÓS - 3 GPUS/NÓ - MEDNEXT - Batch Size 2"
# ==============================================================================
echo "[FASE 1] A Retomar Treino..."
start_time=$(date +%s)
...
srun torchrun \
    ...
    train_seg_DDP.py --epochs $EPOCHS --config $CONFIG_YAML
...
# Passamos --nproc_per_node=2 (em vez de 2) para maximizar o uso de CPUs, já que PyVista é CPU-Bound
