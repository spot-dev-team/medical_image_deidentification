...
#Isto foi criado para verificar se ao cruzar o mapeamento de um exame X com o exame defaced Y (outro paciente completamente diferente) o sistema de reconhecimento facial 
#também dizia que era o mesmoa paciente ou não. Pois antes estavamos a ter níveis de semelhança muito altos entre exames origianis e dfaced do mesmo paicente, então fez se isto para servir de dispiste.
# efetivamente continuou-se a ter altos níveis de similaridade entre exames de diferentes pacientes. No Notion tenho isto bem explicado.
