...
TEST_SOURCE = r"/projects/F202500001HPCVLABEPICURE/andresousa615/rempe/processed_datasets/processed_datasets/teste_noise_cleanse_v2"
...
def main():
    ...
    test_csv = os.path.join(OUTPUT_CSV_DIR, "test_noise_cleanse_v2.csv")
