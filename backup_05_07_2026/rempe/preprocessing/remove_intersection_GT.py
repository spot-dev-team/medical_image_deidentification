...
DIR_ORIGINAL = os.path.join(BASE_DIR, "processed_datasets")
DIR_CANONICAL = os.path.join(BASE_DIR, "processed_datasets_canonical")
# ================================================
...
def remove_brain_intersection():
    ...
    for exam_name in os.listdir(DIR_CANONICAL):
        ...
        try:
            ...
            data_clean_gt[(data_gt_face > 0) & (data_brain > 0)] = 0
