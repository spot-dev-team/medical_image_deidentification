...
MODEL_NAME_BASE="best_mednext_0.0005_mednext_aurora_16gb_vram"
TRAIN_JOB_ID="1071234" # Substitui pelo ID real do teu treino com sucesso
...
WEIGHTS="${BASE_RESULTS}/${MODEL_NAME_BASE}.pt"
