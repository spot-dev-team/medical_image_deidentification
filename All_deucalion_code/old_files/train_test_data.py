"""
================================================================================
AVALIAÇÃO DE LABORATÓRIO / PIPELINE (SANITY CHECK)
================================================================================
Objetivo: Validação matemática rápida e abstrata do modelo.
Este script corre o modelo estritamente dentro da "bolha" do DataLoader de treino, 
calculando o Dice Score sobre os tensores redimensionados (ex: 128x128x128).

Características:
- Avalia uma média cega de performance.
- Não projeta as máscaras na anatomia original do paciente.
- Não guarda ficheiros NIfTI para validação visual.

-> USAR APENAS PARA VERIFICAÇÕES RÁPIDAS (ex: despistar overfitting). 
-> NÃO USAR PARA MÉTRICAS FINAIS DE PRODUÇÃO.
================================================================================
"""
