#Avalia corretamente o Dice score, mas não fornece muita informação sobre os resultados, pelo que usar antes o
#test_data_process.py permite obter os mesmos resultados e verificar que o DSC é baixo pois o GT é terrível e tem imenso ruído.
