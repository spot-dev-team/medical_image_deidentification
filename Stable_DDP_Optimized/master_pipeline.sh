...
#SBATCH --output=logs/pipeline_mednext_4GPUS_profiling_no_elastic_%j.log
#SBATCH --error=logs/pipeline_mednext_4GPUS_profiling_no_elastic_%j.err
...
srun torchrun \
    ...
    train_seg_DDP.py --epochs $EPOCHS --config $CONFIG_YAML $EARLY_STOP_FLAG
